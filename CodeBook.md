...
- Old Feature: t	New Feature: Time	Why : Feature names previously called t as their first character, however this refers to time based observations.
- Old Feature: f	New Feature: Fourier	Why: Feature names previously called f as their first character, however this in fact refers to a Fourier transformation.
- Old Feature: .../..	New Feature: .		Why: Previous feature names had unused characters in the form of full stops. These were reduced down.
- Old Feature: mean	New Feature: Mean	Why: Standardised across all, whether at the end or in the middle of the variable name.
- Old Feature: std	New Feature: StandardDeviation	Why: As one of the key measures, this needed to be clear. Previous naming 'std' was not clear.
